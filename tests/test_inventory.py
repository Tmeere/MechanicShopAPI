...
class TestInventory(unittest.TestCase):
    ...
    #     }
    #     cust_response = self.client.post('/customers', json=customer_payload)
    #     print("Customer response status:", cust_response.status_code)
    #     print("Customer response data:", cust_response.data)
    #     self.assertIn(cust_response.status_code, [200, 201])
    ...
    #         "salary": 50000
    #     }
    #     mech_response = self.client.post('/mechanics', json=mechanic_payload)
    #     mechanic_id = mech_response.json['id']
    ...
    #         "price": 25.00
    #     }
    #     item_response = self.client.post('/inventory/items', json=inventory_payload)
    #     item_id = item_response.json['id']

    #     # Create a service ticket with the actual customer and mechanic IDs
    #     ticket_payload = {
    #         "vin": "1HGCM82633A123456",
    #         "customer_id": customer_id,
    #         "mechanic_ids": [mechanic_id]
    #     }
    #     ticket_response = self.client.post('/service_ticket', json=ticket_payload)
    #     print("Ticket response status:", ticket_response.status_code)
    #     print("Ticket response data:", ticket_response.data)
    #     self.assertIn(ticket_response.status_code, [200, 201])
    ...
    #         "quantity": 2
    #     }
    #     response = self.client.post(f'/inventory/assign-item/{item_id}', json=assign_payload)
    #     self.assertEqual(response.status_code, 200)
